...
<body class="w-screen h-screen flex justify-center">
  <div class="form-container flex flex-row mb-5 w-56 gap-5 items-center justify-center">
      ...
      <div class="container2">
        <input type="text" name="sertifikasi" id="" value="{{ $sertifikasi->nomor_sertifikasi }}" readonly>
        <input type="text" name="suratizin" id="" value="{{ $suratizin->nomor_surat }}" readonly>
      </div>
  </div>
</body>
</html>