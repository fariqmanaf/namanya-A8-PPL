  ...
  <div class="container w-[85vw] bg-[#DDF2FD] flex flex-col h-full ml-[20vw]">
    <div class="menu-pintasan ml-12 mt-12">
      ...
      <div class="box flex gap-6">
        <div class="box-pintasan1 h-44 w-44 bg-white rounded-xl shadow-xl flex flex-col items-center justify-center gap-2 cursor-pointer">
          <img src="{{ asset('/assets/bold/add-ib.svg') }}" alt="">
          <p class="text-center w-11/12 text-[#427D9D] font-semibold">Buat Laporan IB</p>
        </div>
        <div class="box-pintasan2 h-44 w-44 bg-white rounded-xl shadow-xl flex flex-col items-center justify-center cursor-pointer">
