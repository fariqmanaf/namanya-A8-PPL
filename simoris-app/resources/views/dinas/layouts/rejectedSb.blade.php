...
<div class="content-container w-[70vw] bg-[#DDF2FD] flex flex-col h-full ml-[22vw] mt-10">
  <div class="buttonSwap ml-6 font-semibold mb-6">
    ...
    <a href="/dashboard/pengajuan-stok/confirmed"><button id="button3" class="p-1 -ml-6 py-2 hover:bg-gray-200 w-40 bg-white shadow-md rounded-2xl">Disetujui</button></a>
    <a href="#"><button id="button4" class="p-1 -ml-6 py-2  text-white w-40 bg-[#427D9D] shadow-md rounded-2xl">Ditolak</button></a>
  </div>
          ...
          <div class="content flex flex-row items-center gap-4">
            ...
            <div class="flex flex-col">
              <div class="text text-md p-1 flex-row flex gap-5">
                ...
                <p class="px-1 w-40 h-6 text-sm rounded-full text-white font-semibold bg-red-600 text-center">Rejected</p>
              </div>
