    ...
    <div class="menu-pintasan ml-12 mt-12">
      ...
      <div class="box flex gap-6">
        <div class="box-pintasan1 h-44 w-44 bg-white rounded-2xl shadow-xl flex flex-col items-center justify-center gap-2 cursor-pointer">
          <img src="{{ asset('/assets/bold/people-b.svg') }}" alt="">
          <p class="text-center w-11/12 text-[#427D9D] font-semibold">Data Mantri</p>
        </div>
        <div class="box-pintasan2 h-44 w-44 bg-white rounded-2xl shadow-xl flex flex-col items-center justify-center cursor-pointer">
          ...
          <p class="text-center w-11/12 text-[#427D9D] font-semibold">Cek Laporan IB</p>
        </div>
      </div>
    </div>
    <div class="menu-pintasan ml-12 mt-12">
      ...
      <div class="box flex gap-6">
        <div class="box-pintasan1 h-44 w-44 bg-white rounded-2xl shadow-xl flex flex-col items-center justify-center gap-2 cursor-pointer">
          <img src="{{ asset('/assets/bold/document2-b.svg') }}" alt="">
          <p class="text-center w-11/12 text-[#427D9D] font-semibold">Data Sapi</p>
        </div>
      </div>
    </div>
  </div>
