var map = L.map('map', {
  ...
  var locations = [
    ...
    {coords: [-8.206290727885495, 113.70713730767544], name: 'Mumbulsari', totalStok: total[13], sisaStok: sisa[13]},
    {coords: [-8.13031244576908, 113.79532618893182], name: 'Pakusari', totalStok: total[14], sisaStok: sisa[14]},
    {coords: [-8.085041936968791, 113.63691282815651], name: 'Panti', totalStok: total[15], sisaStok: sisa[15]},
    {coords: [-8.122228800277833, 113.70877043510613], name: 'Patrang', totalStok: total[16], sisaStok: sisa[16]},
    {coords: [-8.337197856753393, 113.47196695765847], name: 'Puger', totalStok: total[17], sisaStok: sisa[17]},
    {coords: [-8.165878548220709, 113.60751653440438], name: 'Rambipuji', totalStok: total[18], sisaStok: sisa[18]},
    {coords: [-8.182043912054231, 113.4523694284904], name: 'Semboro', totalStok: total[19], sisaStok: sisa[19]},
    {coords: [-8.245082553707435, 113.85248564900537], name: 'Silo', totalStok: total[20], sisaStok: sisa[20]},
    {coords: [-8.123845542402778, 113.67284163163131], name: 'Sukorambi', totalStok: total[21], sisaStok: sisa[21]},
    {coords: [-8.023595266392867, 113.84105375699069], name: 'Sukowono', totalStok: total[22], sisaStok: sisa[22]},
    {coords: [-8.086658828523639, 113.39357684098616], name: 'Sumberbaru', totalStok: total[23], sisaStok: sisa[23]},
    {coords: [-8.037099629736469, 113.90416443419127], name: 'Sumberjambe', totalStok: total[24], sisaStok: sisa[24]},
    {coords: [-8.14994744257269, 113.70641052988803], name: 'Sumbersari', totalStok: total[25], sisaStok: sisa[25]},
    {coords: [-8.15257735679913, 113.46349079008296], name: 'Tanggul', totalStok: total[26], sisaStok: sisa[26]},
    {coords: [-8.386631077113858, 113.72934608541338], name: 'Tempurejo', totalStok: total[27], sisaStok: sisa[27]},
    {coords: [-8.257065307963613, 113.44886710960186], name: 'Umbulsari', totalStok: total[28], sisaStok: sisa[28]},
    {coords: [-8.312151420940431, 113.54858961795017], name: 'Wuluhan', totalStok: total[29], sisaStok: sisa[29]}
  ];
